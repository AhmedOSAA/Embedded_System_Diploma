...
typedef struct{
	...
	uint8_t Clock_Rate ;				// Specify the LSB or MSB of the data word is transmitted first.
...
uint8_t SPI_SendData (SPI_typedef* SPIx , uint8_t data);
unsigned char SPI_ReveiveData (SPI_typedef* SPIx ,unsigned char dataTOsend);
