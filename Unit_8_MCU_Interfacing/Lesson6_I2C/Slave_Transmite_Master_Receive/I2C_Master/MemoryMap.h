...
#define I2CBR	*(volatile uint8_t*)(0x20)
#define I2CSR	*(volatile uint8_t*)(0x21)
#define I2CAR	*(volatile uint8_t*)(0x22)
#define I2CDR	*(volatile uint8_t*)(0x23)
// TWI Control Register and its bits
#define I2CCR	*(volatile uint8_t*)(0x56)
